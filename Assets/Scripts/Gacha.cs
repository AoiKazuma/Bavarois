    ...
    void Start()
    {
        ...
        switch (DataManager.instance.selectedCategoryForGacha)
        {
            case 0:
                ...
                Debug.Log($"{collectionArray.dogArray[index].collectionName}���Q�b�g�����I");
                break;
            case 1:
                saveData.ticket_cat--;
                ...
                Debug.Log($"{collectionArray.catArray[index].collectionName}���Q�b�g�����I");
                break;
            case 2:
                ...
                Debug.Log($"{collectionArray.birdArray[index].collectionName}���Q�b�g�����I");
                break;
            case 3:
                ...
                Debug.Log($"{collectionArray.reptilesArray[index].collectionName}���Q�b�g�����I");
                break;
            case 4:
                ...
                Debug.Log($"{collectionArray.originalArray[index].collectionName}���Q�b�g�����I");
                break;
        }
    }
